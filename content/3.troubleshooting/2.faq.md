...
1. **Auto-check**: Checks for updates on startup (enabled by default)
2. **Tauri Updater**: Connected to our update server for secure downloads
3. **Notification**: Alerts you when available
4. **Download**: Click to download update
5. **Install**: Install and restart
